...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.maximizeExplorer": "Maximize file browser to fill the sidebar",
    "sidebar.restoreExplorer": "Restore file browser split view",
    "sidebar.maximizeSessions": "Collapse file browser and maximize sessions",
    "sidebar.restoreSessions": "Expand file browser and restore split view",
    "sidebar.changedFiles": "{count} changed files",
    "sidebar.loading": "Loading...",
    "sidebar.sessionListWithCount": "Sessions {count}",
    "sidebar.collapseSessions": "Collapse session list",
    "sidebar.expandSessions": "Expand session list",
    "sidebar.deleteSessionsOlderThan": "Delete sessions older than {days} days ({count})",
    "sidebar.deleteAllSessions": "Delete all sessions ({count})",
    "sidebar.confirmDeleteSessions": "This will delete {count} sessions not modified in the last {days} days. This cannot be undone.",
    "sidebar.confirmDeleteAllSessions": "This will delete all {count} sessions in the current project. This cannot be undone.",
    "sidebar.deletingSessions": "Deleting…",
    "sidebar.skippedRunningSessions": "Skipped {count} running sessions",
    "sidebar.runningSessionsSkippedNote": "Running sessions will be skipped automatically.",
    ...
    "files.deleteFolderWarning": "Move folder \"{name}\" and all its contents to the trash? It cannot be undone.",
    "files.deleting": "Moving to trash...",
    "files.newFile": "New File",
    "files.newFolder": "New Folder",
    "files.copyPath": "Copy Path",
    "files.pathCopied": "Path copied to clipboard",
    "files.nameExists": "A file or folder with that name already exists",
    "files.invalidName": "Invalid file name",
    "files.renameError": "Failed to rename",
    "files.createError": "Failed to create",
    "files.moveError": "Failed to move",
    "files.copyFailed": "Failed to copy path to clipboard",
    "files.moveToTrashMultiple": "Move {count} item{countSuffix} to Trash",
    "files.copyPathMultiple": "Copy {count} Path{countSuffix}",
    "files.deleteMultipleWarning": "Move {count} item{countSuffix} to the trash? (e.g. \"{preview}\") It cannot be undone.",
    ...
    "goal.edit": "Edit",
    "goal.clear": "Clear",
    "goal.editHint": "Cmd+Enter to save · Esc to cancel",
    "i18n.close": "Close",
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.cancel": "Cancel",
