...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.maximizeExplorer": "文件浏览器最大化（占满整个侧栏）",
    "sidebar.restoreExplorer": "还原文件浏览器分栏",
    "sidebar.maximizeSessions": "折叠文件浏览器，最大化会话列表",
    "sidebar.restoreSessions": "展开文件浏览器，恢复分栏",
    "sidebar.changedFiles": "{count} 个变更文件",
    "sidebar.loading": "加载中...",
    "sidebar.sessionListWithCount": "会话列表 {count}",
    "sidebar.collapseSessions": "折叠会话列表",
    "sidebar.expandSessions": "展开会话列表",
    "sidebar.deleteSessionsOlderThan": "删除超过 {days} 天的会话 ({count})",
    "sidebar.deleteAllSessions": "删除全部会话 ({count})",
    "sidebar.confirmDeleteSessions": "将删除 {count} 个超过 {days} 天未修改的会话，此操作不可恢复。",
    "sidebar.confirmDeleteAllSessions": "将删除当前项目的全部 {count} 个会话，此操作不可恢复。",
    "sidebar.deletingSessions": "删除中…",
    "sidebar.skippedRunningSessions": "已跳过 {count} 个运行中的会话",
    "sidebar.runningSessionsSkippedNote": "运行中的会话会自动跳过。",
    ...
    "files.deleteFolderWarning": "要将文件夹「{name}」及其所有内容移到回收站吗？此操作无法撤销。",
    "files.deleting": "正在移到回收站…",
    "files.newFile": "新建文件",
    "files.newFolder": "新建文件夹",
    "files.copyPath": "复制路径",
    "files.pathCopied": "路径已复制到剪贴板",
    "files.nameExists": "已存在同名文件或文件夹",
    "files.invalidName": "文件名无效",
    "files.renameError": "重命名失败",
    "files.createError": "新建失败",
    "files.moveError": "移动失败",
    "files.copyFailed": "复制路径到剪贴板失败",
"files.moveToTrashMultiple": "将 {count} 个项目移到废纸篓",
"files.copyPathMultiple": "复制 {count} 个路径",
"files.deleteMultipleWarning": "确定要将 {count} 个项目移到废纸篓吗？（例如「{preview}」）此操作无法撤销。",
"files.refresh": "刷新",
"files.selectNone": "取消全选",
    ...
    "chat.extensionWidgets": "扩展小组件",
    "chat.extensionWidgetAbove": "编辑器上方小组件",
    "chat.extensionWidgetBelow": "编辑器下方小组件",
    ...
    "goal.edit": "编辑",
    "goal.clear": "清除",
    "goal.editHint": "Cmd+Enter 保存 · Esc 取消",
    "i18n.close": "关闭",
    "i18n.copy": "复制",
    "i18n.copied": "已复制",
    "i18n.cancel": "取消",
    ...
    "i18n.attentionNeeded": "Pi 需要你的关注",
