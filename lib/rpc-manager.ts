  ...
  async send(command: Record<string, unknown>): Promise<unknown> {
    ...
    switch (type) {
      case "prompt": {
        ...
        if (silent) {
          // Silent prompts (e.g., goal commands) bypass admission serialization
          // and prompt tracking. Errors surface as extension_error, not prompt_error.
          void this.inner.prompt(command.message as string, {
